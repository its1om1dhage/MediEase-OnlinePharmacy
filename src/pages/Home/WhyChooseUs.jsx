...
const WhyChooseUs = () => {
  const features = [
    {
      ...
      description: 'All our pharmacists are licensed professionals',
    },
    {
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: '100% authentic medicines from trusted sources',
    },
    {
      icon: (
        <svg className="w-12 h-12 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="mb-8 bg-white rounded-lg shadow-md p-8">
      <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Why Choose MediEase?</h2>
